...
$(function(){Views.App=Backbone.View.extend({});});
...
$(function(){Handlers.Abstract.Category=Class.extend({});})
$(function(){Handlers.Category=Handlers.Abstract.Category.extend({handleCMenu:function(e){Views.CategoryCMenu.getInstance({el:$("#cm-cats")}).show({x:e.pageX,y:e.pageY});}});})
$(function(){Handlers.Group=Handlers.Abstract.Category.extend({handleCMenu:function(e){Views.GroupCMenu.getInstance({el:$("#cm-groups")}).show({x:e.pageX,y:e.pageY});}});});